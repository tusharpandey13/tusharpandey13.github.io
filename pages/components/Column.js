const Column = props => {
  ...
  return (
    <div
      className={`flex flex-col flex-nowrap tracking-[1px] font-basefont gap-contentgap
    ...
    >
      ...
      {props.description && (
        <p
          className={`text-[12px] font-normal leading-[180%] select-text text-[rgba(0,0,0,0.85)] font-contentfont`}
        >
          {props.description}
        </p>
      )}
      <div className='flex flex-col gap-contentgap select-text'>{props.elements}</div>
    </div>
  );
};
