...
const Project = props => {
  return (
    <a href={props.url} target='blank'>
      <div
        className={`flex flex-col p-contentgap min-h-[200px] gap-contentgap tracking-[1px] text-[14px] 
      ...
      >
        <div className='flex flex-col gap-contentgap'>
          ...
          <p
            className={`text-[12px] leading-[100%] pr-contentgap font-light text-[rgba(0,0,0,0.85)] font-contentfont`}
          >
